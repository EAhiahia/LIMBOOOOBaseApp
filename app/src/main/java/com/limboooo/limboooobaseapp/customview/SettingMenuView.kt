package com.limboooo.limboooobaseapp.customview
...
import com.limboooo.limboooobaseapp.databinding.MenuSettingBinding
import com.limboooo.limboooobaseapp.utils.DpUtil
...
class SettingMenuView @JvmOverloads constructor(
    ...
    init {
        ...
        binding.root.apply {
            setPadding(DpUtil.dip2px(dpValue = 16f))
//            isClickable = true
        }
